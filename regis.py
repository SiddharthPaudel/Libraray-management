...
photo=PhotoImage(file="time-removebg-preview.png")
Label(root,image=photo,bg="SKY BLUE").place(x=480,y=60)
...
c1 = Checkbutton(root,fg='white',border=0,text ="Show",bg='black',font=('roboto',8),command=show_pass_check,variable=show_pass,onvalue=1,offvalue=0).place(x=380,y=380)
